...
Tikèm now uses **Firebase** (Firestore + Firebase Auth) instead of Supabase. This guide explains the database structure and how to set up your Firebase project.
...
3. Register your app with a nickname (e.g., "Tikèm Web")
