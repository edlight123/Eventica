            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                ...
                {organizer.is_verified && (
                  <div className="flex items-center gap-1 bg-white text-brand-700 px-2 md:px-3 py-0.5 md:py-1 rounded-full text-[11px] md:text-sm font-semibold flex-shrink-0">
