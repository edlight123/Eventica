      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#141414] rounded-xl border border-white/10 shadow-sm p-6 space-y-6">
          ...
          <div className="flex items-start gap-6">
            <div className="w-24 h-24 rounded-full bg-[#242424] animate-pulse" />
            <div className="flex-1">
              <div className="h-10 w-40 bg-[#242424] rounded-lg mb-2 animate-pulse" />
          ...
          {[1, 2, 3].map((i) => (
            <div key={i}>
              <div className="h-5 w-24 bg-[#242424] rounded mb-2 animate-pulse" />
          ...
          <div className="flex justify-end pt-4">
            <div className="h-11 w-32 bg-[#242424] rounded-lg animate-pulse" />
          </div>
        </div>
      </div>
    </div>
