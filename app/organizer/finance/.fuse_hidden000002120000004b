        ...
        <PageHeader
          ...
          actions={
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-[#141414] px-4 py-2.5 text-sm font-semibold text-white/70 transition-colors hover:bg-white/[0.08] hover:text-white"
            >
              Payout settings
            </Link>
          }
