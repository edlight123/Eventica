            ...
            <div className="text-center">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 border-2 border-white/10 rounded-lg font-semibold text-white/70 hover:bg-[#0a0a0a] transition-all"
                >
                  Continue Editing
                </button>
                <button
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
              ...
              <button
                type="button"
                onClick={() => router.push('/organizer/verify')}
                className="px-4 py-2 bg-[#141414] border border-amber-300 text-amber-900 rounded-lg font-semibold hover:bg-amber-500/15 transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Tab Content */}
            <div className="bg-[#141414] rounded-xl border-2 border-white/10 p-6 md:p-8 shadow-sm">
              {renderCurrentTab()}
            </div>
              ...
              <div className="flex items-center gap-3">
                {currentTab !== 'basic' && (
                  <button
                    ...
                    className="px-6 py-2.5 border-2 border-white/10 rounded-lg font-semibold text-white/70 hover:border-white/15 hover:bg-[#0a0a0a] transition-all"
                  >
                    ← Previous
                  </button>
                )}
