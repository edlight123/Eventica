...
export function DetailsTab({ formData, onChange, validation }: DetailsTabProps) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      {/* Section Header */}
      <div>
        <h2 className="font-display text-2xl text-white mb-2">Event Details</h2>
      ...
      <div>
        ...
        <div className="flex gap-3 mb-4">
          <input
            ...
            className="flex-1 px-4 py-3 border-2 border-white/10 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all"
          />
          <button
            type="button"
            onClick={() => {
