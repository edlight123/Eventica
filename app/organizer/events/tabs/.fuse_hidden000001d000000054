...
export function TicketsTab({ formData, onChange, tiers, onTiersChange, validation }: TicketsTabProps) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      {/* Section Header */}
      <div>
        <h2 className="font-display text-2xl text-white mb-2">Ticket Information</h2>
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-3 border-2 border-white/10 rounded-xl focus:ring-2 focus:ring-brand-500 transition-all"
        >
      ...
      {/* Premium Tiers */}
      <div className="bg-[#141414] border-2 border-white/10 rounded-xl p-6">
        ...
        {tiers.length === 0 ? (
          ...
          <div className="space-y-4">
            {tiers.map((tier, index) => (
              <div key={index} className="bg-[#0a0a0a] border-2 border-white/10 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., VIP"
                      className="w-full px-3 py-2 border-2 border-white/10 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 text-sm"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-white/70 mb-1">
