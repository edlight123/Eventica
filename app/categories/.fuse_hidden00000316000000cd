        ...
        {initialCategory && (
          <div>
            ...
            {loading ? (
              ...
              <div className="text-center py-12 md:py-16 bg-white/5 rounded-xl md:rounded-2xl border border-white/10">
                <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-brand-500/15 mb-3 md:mb-4">
