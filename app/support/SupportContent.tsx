...
export default function SupportContent() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl border-0 shadow-lg text-white placeholder-white/40 focus:ring-2 focus:ring-brand-400 focus:outline-none"
              />
            </div>
          </div>
        </div>
      ...
      {/* Role Toggle */}
      <div className="bg-[#0a0a0a] border-b border-white/10 sticky top-0 z-10 shadow-sm">
            ...
            <div key={category.id} id={category.id} className="scroll-mt-20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/65">{category.description}</p>
                </div>
              </div>
