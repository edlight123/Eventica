        ...
        <div className="bg-white rounded-xl shadow-md p-6 md:p-8 text-center">
          {!timedOut ? (
            <>
              ...
              <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Confirming your payment…</h1>
            ...
            <>
              <div className="w-14 h-14 md:w-16 md:h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-7 h-7 md:w-8 md:h-8 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Still confirming your payment</h1>
