  ...
  return (
    <div>
      ...
      <div className="mb-5 sm:mb-6 space-y-2">
        ...
        <div className="h-4 w-80 max-w-full rounded bg-white/[0.04] animate-pulse" />
      </div>
      {/* Poster rail */}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-mobile-nav">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 md:pt-8">
        <div className="h-[260px] sm:h-[340px] md:h-[420px] rounded-3xl bg-white/[0.06] animate-pulse" />
      </div>
