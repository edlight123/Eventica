    ...
    <div className="min-h-screen bg-gray-50 pb-mobile-nav">
      <Navbar user={user} />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-12">
          ...
          <p>
            By accessing and using Tikèm (&quot;the Platform&quot;), you accept and agree to be bound by the terms and provision of this agreement.
          </p>
          ...
          <ul>
            ...
            <li>Tikèm acts as an intermediary and is not liable for event cancellations or changes</li>
          </ul>

          <h2>5. User Content</h2>
          <p>
            Users may post reviews, comments, and other content. By posting content, you grant Tikèm a non-exclusive, royalty-free, perpetual license to use, reproduce, modify, and display such content.
          </p>
          ...
          <p>
            Payments are processed securely through third-party payment processors. Tikèm does not store credit card information. A service fee may be applied to ticket purchases.
          </p>

          <h2>8. Limitation of Liability</h2>
          <p>
            Tikèm shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of the Platform or any events listed on it.
          </p>
          ...
          <p>
            Tikèm reserves the right to revise these terms at any time. Continued use of the Platform after changes constitutes acceptance of modified terms.
          </p>
