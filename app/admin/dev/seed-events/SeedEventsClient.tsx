...
export default function SeedEventsClient() {
  ...
  return (
    <div className="container max-w-4xl mx-auto py-8 px-4">
      <div className="bg-[#141414] dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div className="mb-6">
        ...
        <div className="mb-6 grid gap-3">
          ...
          {verifyResult && (
            <div
              className={`p-4 rounded-lg ${verifyResult.ok ? 'bg-emerald-500/10 border border-emerald-500/30' : 'bg-red-500/10 border border-red-500/30'}`}
            >
        ...
        <div className="space-y-6">
          ...
          {result && (
            <div
              className={`p-4 rounded-lg ${result.success ? 'bg-emerald-500/10 border border-emerald-500/30' : 'bg-red-500/10 border border-red-500/30'}`}
            >
                ...
                <div className="mt-4 max-h-96 overflow-y-auto">
                  ...
                  <div className="space-y-2">
                    {result.events.map((event, idx) => (
                      <div key={event.id} className="text-xs bg-[#141414] p-2 rounded border">
