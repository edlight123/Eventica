    ...
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 pb-mobile-nav">
        <div className="mb-4 sm:mb-5">
          ...
          />
          {unreviewedCount > 0 && (
            <div className="mt-3 sm:mt-4 border border-red-500/30 rounded-lg p-3 sm:p-4">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {activity.reviewed && (
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-emerald-300">
                          ✓ Reviewed
                        </span>
                      )}
                    </div>
