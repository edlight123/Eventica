              ...
              {Object.entries(steps).map(([stepKey, stepValue]: any) => {
                ...
                return (
                  <div key={stepKey} className="border border-white/10 rounded-lg p-3 sm:p-4 bg-[#0a0a0a]">
                    ...
                    {errorMessage ? (
                      <div className="text-[12px] sm:text-sm text-red-300 bg-red-500/10 border border-red-500/30 rounded p-2 mb-2">
                        {errorMessage}
                      </div>
                    ) : null}

                    {missingFields.length > 0 ? (
                      <div className="text-[12px] sm:text-sm text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded p-2 mb-2">
