...
1. **Visit the Firebase Console:**
   - Go to https://console.firebase.google.com/project/tikem/firestore/indexes
...
```
https://console.firebase.google.com/v1/r/project/tikem/firestore/indexes?create_composite=...
```
