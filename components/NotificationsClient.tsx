      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="flex items-center gap-2">
              {unreadCount > 0 && (
                <button
                  ...
                  disabled={isLoading}
                  className="px-3 py-2 text-sm font-medium text-brand-300 hover:text-brand-200 transition-colors disabled:opacity-50"
                >
                  {t('mark_all_read')}
                </button>
              )}
        ...
        {notifications.length === 0 ? (
          <div className="p-12 text-center">
            <Bell className="w-12 h-12 text-white/40 mx-auto mb-4" strokeWidth={1.5} />
          ...
          <div className="border-t border-white/10">
            {notifications.map((notification) => (
              <div
                ...
                className="cursor-pointer border-b border-white/10 px-1 py-4 transition-colors hover:bg-[#0a0a0a]"
              >
                    ...
                    {notification.type === 'staff_invite' && (
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 text-sm font-medium bg-white/[0.04] text-white/70 rounded-md hover:bg-white/[0.06] transition-colors"
                        >
                          Decline
                        </button>
                      </div>
