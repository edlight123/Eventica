    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-white/10 p-6">
        ...
        {hasNotificationPermission() ? (
          <div className="flex items-center gap-2 p-4 border border-green-200 rounded-lg">
      ...
      <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-white/10 p-6">
        ...
        {/* Save Indicator */}
        {saved && (
          <div className="mt-4 p-3 border border-green-200 rounded-lg flex items-center gap-2">
            <Check className="w-5 h-5 text-green-600" />
