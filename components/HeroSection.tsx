...
export default function HeroSection({ hasActiveFilters, featuredEvents }: HeroSectionProps) {
  ...
  const SearchForm = (
    <form
      ...
      className="reveal reveal-3 mt-6 flex w-full max-w-2xl flex-wrap items-center gap-2 rounded-2xl  bg-white/5 p-2 shadow-poster-sm backdrop-blur-md"
    >
                ...
                <div className="poster-vignette relative aspect-[4/5] overflow-hidden rounded-3xl shadow-card-hover ring-1 ring-white/10 transition-transform duration-500 group-hover:-translate-y-1">
                  ...
                  <div className="absolute inset-x-0 bottom-0 z-10 p-4 text-white">
                    ...
                    <div className="mt-2 flex items-center justify-between gap-2">
                      ...
                      <span className="shrink-0 rounded-lg bg-white/95 px-2.5 py-1 text-[12px] font-bold text-gray-900 backdrop-blur-md">
