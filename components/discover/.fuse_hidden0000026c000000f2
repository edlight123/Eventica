  ...
  return (
    <div className="space-y-4">
      <div className="flex items-end justify-between">
        ...
        <div className="hidden sm:block h-5 w-16 bg-white/10 rounded" />
      </div>
    ...
    <div className="bg-[#0a0a0a] border-b border-white/10 animate-pulse">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center gap-3">
          <div className="h-11 flex-1 bg-white/10 rounded-lg" />
          <div className="hidden md:block h-11 w-28 bg-white/10 rounded-full" />
          <div className="h-11 w-24 bg-white/10 rounded-lg" />
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5">
          <div className="flex gap-2 overflow-hidden">
            {Array.from({ length: 9 }).map((_, i) => (
              <div key={i} className="h-8 w-20 bg-white/10 rounded-full shrink-0" />
            ))}
          </div>
        </div>
      </div>
