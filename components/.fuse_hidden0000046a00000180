...
export default function SearchFilters({ onSearch, onFilterChange }: SearchFiltersProps) {
  ...
  return (
    <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-white/10 p-6 mb-8">
      {/* Search Bar */}
      <div className="mb-4">
        <div className="relative">
          <input
            ...
            className="w-full pl-12 pr-4 py-3 border border-white/10 rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-transparent"
          />
          <svg
      ...
      <button
        ...
        className="flex items-center space-x-2 text-teal-700 font-medium hover:text-brand-300 transition"
      >
        ...
        <div className="mt-6 pt-6 border-t border-white/10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-white/10 rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-transparent"
            >
              {CATEGORIES.map(cat => (
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="w-1/2 px-3 py-2 border border-white/10 rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-transparent"
              />
              <input
                type="number"
                placeholder="Max"
          ...
          <div className="md:col-span-2 lg:col-span-4">
            <button
              ...
              className="text-sm text-teal-700 hover:text-brand-300 font-medium"
            >
              Clear All Filters
            </button>
          </div>
