      ...
      {currentReceiptUrl && !selectedFile && (
        <div className="border rounded-lg p-4 bg-emerald-500/10 border-emerald-500/30">
          ...
          {currentReceiptUrl.includes('.pdf') ? (
            <div className="flex items-center gap-3 p-3 bg-[#141414] rounded border">
            ...
            <div className="relative w-full h-48 bg-[#141414] rounded border">
              <Image
      ...
      <div className="border rounded-lg p-4">
          ...
          <label
            ...
            className={`flex items-center justify-center gap-2 border-2 border-dashed rounded-lg p-6 cursor-pointer transition-colors ${
              uploading
                ...
                : 'hover:bg-[#0a0a0a] border-white/10 hover:border-brand-400'
            }`}
          >
        ...
        {selectedFile && (
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between p-3 bg-brand-500/10 border border-brand-500/30 rounded-lg">
