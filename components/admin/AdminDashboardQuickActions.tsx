        ...
        {sortedActions.map((action) => {
          ...
          return (
            <Link
              ...
              className="group relative rounded-xl border border-white/10 bg-white/[0.02] p-3 flex flex-col gap-2 hover:bg-white/[0.04] hover:border-white/20 transition-all"
            >
