...
export default function BankVerificationReviewCard({ verification }: Props) {
  ...
  return (
    <div className="bg-[#141414] rounded-2xl border-2 border-white/10 overflow-hidden">
      {/* Header - Always Visible */}
      <div
        className="p-6 cursor-pointer hover:bg-[#0a0a0a] transition-colors"
      ...
      {expanded && (
        <div className="border-t border-white/10 p-6 bg-[#0a0a0a]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#141414] rounded-xl p-6 border-2 border-brand-500/30">
