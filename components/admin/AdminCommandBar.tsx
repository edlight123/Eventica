      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center gap-4">
                    ...
                    {searchResults.map((result) => (
                      ...
                      >
                        ...
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${
                          result.type === 'event' ? 'bg-brand-500/10' :
                          result.type === 'user' ? 'bg-brand-500/10' :
                          'bg-emerald-500/15'
                        }`}>
                          {result.type === 'event' ? (
          ...
          {pendingVerifications > 0 && (
            <Link
              href="/admin/verify"
              className="relative flex items-center gap-2 px-3 py-2 bg-amber-500/10 text-amber-300 rounded-lg hover:bg-amber-500/15 transition-colors"
            >
