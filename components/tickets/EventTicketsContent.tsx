...
export default function EventTicketsContent({ event, tickets }: EventTicketsContentProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
      {/* Event Hero Card */}
      <div className="relative bg-[#0a0a0a] rounded-2xl shadow-sm border border-white/10 overflow-hidden mb-6">
        {/* Banner Image */}
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            {validTickets.map((ticket, index) => (
              <div
                key={ticket.id}
                className="group relative bg-[#0a0a0a] rounded-xl shadow-sm border border-white/10 hover:border-brand-400 hover:shadow-md transition-all overflow-visible"
              >
                {/* Ticket Number Badge */}
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            {usedTickets.map((ticket) => (
              <div
                key={ticket.id}
                className="relative bg-[#0a0a0a] rounded-xl shadow-sm border border-white/10 overflow-hidden opacity-75"
              >
                <div className="absolute top-3 right-3 z-10">
