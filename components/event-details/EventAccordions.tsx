      ...
      <div className="bg-[#0a0a0a] rounded-2xl border border-white/10 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-white">About This Event</h3>
          </div>
      ...
      <div className="bg-[#0a0a0a] rounded-2xl border border-white/10 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-white">Venue & Directions</h3>
          </div>
        ...
        {openSections.has('venue') && (
          <div className="px-4 pb-4 border-t border-white/10">
            <div className="space-y-3 mt-4">
              <div>
                <p className="text-xs font-semibold text-white/50 mb-1">VENUE</p>
                <p className="text-sm font-semibold text-white">{venueName}</p>
              </div>
              <div>
                <p className="text-xs font-semibold text-white/50 mb-1">ADDRESS</p>
      ...
      <div className="bg-[#0a0a0a] rounded-2xl border border-white/10 overflow-hidden">
        ...
        {openSections.has('schedule') && (
          <div className="px-4 pb-4 border-t border-white/10">
            <div className="space-y-3 mt-4">
              <div>
                <p className="text-xs font-semibold text-white/50 mb-1">START</p>
              ...
              <div>
                <p className="text-xs font-semibold text-white/50 mb-1">END</p>
                <p className="text-sm font-semibold text-white">
