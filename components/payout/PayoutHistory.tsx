                ...
                <td className="py-4 px-4 text-right">
                  {payout.status === 'failed' && (
                    <button 
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-brand-700 hover:bg-brand-50 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed rounded-lg transition-colors"
                    >
          ...
          >
            ...
            {payout.status === 'failed' && (
              <button 
                onClick={() => handleRetry(payout.id)}
                disabled={retrying === payout.id}
                className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-brand-700 hover:bg-brand-50 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed border-2 border-brand-600 disabled:border-gray-300 rounded-lg transition-colors"
              >
