...
export function EditEventHeader({
  ...
  return (
    <div className="sticky top-0 z-50 bg-[#141414] border-b border-white/10 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            {eventId && (
              <Link
                href={`/events/${eventId}`}
                target="_blank"
                className="flex items-center gap-2 px-4 py-2.5 rounded-lg font-semibold bg-[#141414] text-white/70 hover:bg-[#0a0a0a] border-2 border-white/15 transition-all"
              >
