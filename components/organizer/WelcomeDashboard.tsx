        ...
        <div className="bg-brand-700 rounded-2xl p-6 md:p-8 text-white">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <Link
              ...
              className="flex-shrink-0 inline-flex items-center gap-2 bg-[#141414] text-brand-300 px-6 py-3 rounded-xl font-semibold hover:bg-brand-500/10 transition-colors shadow-lg"
            >
