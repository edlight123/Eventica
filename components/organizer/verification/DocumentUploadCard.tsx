...
export default function DocumentUploadCard({
  ...
  return (
    <div className="bg-[#141414] border border-white/10 rounded-lg p-4 md:p-6">
      {/* Header */}
      <div className="mb-4">
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                <button
                  ...
                  disabled={disabled}
                  className="px-4 py-2 text-sm font-medium text-brand-300 bg-[#141414] border-2 border-brand-700 rounded-lg hover:bg-brand-500/10 transition-colors disabled:opacity-50"
                >
                  Choose File
                </button>
                <button
