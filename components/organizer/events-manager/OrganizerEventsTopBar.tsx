      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="hidden md:flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-md relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 bg-[#0a0a0a] border border-white/15 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
              />
              {localQuery && (
                <button
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative px-4 py-2.5 bg-[#141414] border border-white/15 rounded-xl text-sm font-medium text-white/70 hover:bg-[#0a0a0a] transition-all flex items-center gap-2"
            >
        ...
        <div className="md:hidden space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onOpenFilters}
              className="relative flex-1 px-4 py-2.5 bg-[#141414] border border-white/15 rounded-xl text-sm font-medium text-white/70 hover:bg-[#0a0a0a] transition-all flex items-center justify-center gap-2"
            >
              <SlidersHorizontal className="w-4 h-4" />
              <span>{t('events_page.filters')}</span>
              {activeFiltersCount > 0 && (
