...
1. Go to **Firebase Console**: https://console.firebase.google.com/project/tikem/authentication/providers
...
5. Save it to `/workspaces/Tikèm/mobile/GoogleService-Info.plist`
...
4. Save to `/workspaces/Tikèm/mobile/google-services.json`
...
1. **Google Web Client ID** from Firebase Console
   - Go to: https://console.firebase.google.com/project/tikem/authentication/providers
